...
router.post('/sendMessage', auth(), petController.sendMessage);
router.get('/sendMessage', auth(), petController.getMessages);
router.put('/sendMessage', auth(), petController.deleteMessage);
